...
export class LanguageService {
  ...
  public supportLanguages: Language[] = [
    ...
    { gt: "zh-CN", name: "ChineseSimplified", languageCode: "zh_CN" },
    { gt: "zh-TW", name: "ChineseTraditional", languageCode: "zh_TW" },
    ...
    { gt: "ht", name: "HaitianCreole", languageCode: "ht" },
    ...
    { gt: "gd", name: "ScotsGaelic", languageCode: "gd" },
