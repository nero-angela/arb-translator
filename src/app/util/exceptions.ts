...
export class SourceArbRequiredException extends Error {}

export class InvalidSourceArbException extends Error {}

export class InvalidSourceLangException extends Error {}
